...
var julyuhc = new Discord.RichEmbed()
    ...
    .addField('July 30 at 3 PM EST', "For the first time we'll be returning to the true basics of UHC. This month, in order to win, you need to kill the Ender Dragon! Don't despair though, you also have the option to murder all of the enemies if that's more your style.")
    .setFooter('The Aquarium Discord');
